...
const tableConfigs = {
  ...
  sklad_inventory: { label: '🏭 Склад', table: 'inventory', readOnlyTab: true, fields: [ { name: 'ID Детайл', type: 'text', readonlyOnEdit: true }, { name: 'Име', type: 'text', readonlyOnEdit: true }, { name: 'Локация', type: 'text', readonlyOnEdit: true }, { name: 'Операция', type: 'text', readonlyOnEdit: true }, { name: 'Количество', type: 'number', readonlyOnEdit: true } ] },
